"""
Django settings for diit_library project.
...
SECRET_KEY = '^fe)9=g+bg5ics8uu9&@wxgl_um@tigw3ri2!=a)2k+rcni_^f'
...
ROOT_URLCONF = 'diit_library.urls'
...
WSGI_APPLICATION = 'diit_library.wsgi.application'
